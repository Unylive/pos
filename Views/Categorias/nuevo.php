...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid">
            ...
            <form method="POST" action="<?php echo base_url(); ?>/categoriasContr/insertar" autocomplete="off">
                <!-- 2do paso agregamos un "div" -->
                <div class="form-group">
                    <div class="row">
                        <div class="col-12 col-sm-6"> <!-- dentro de este div agregamos label -->
                            <label>Nombre</label>
                            <input class="form-control" id="nomb_categ" name="nomb_categ" type="text" autofocus require />
                        </div>
                    </div>
                </div>    
