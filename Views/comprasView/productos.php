    ...
    <main>
        <div class="container-fluid">
            ...
            <!-- a los botones agregamos el diseño con "class" -->
                <p>
                    <a href="<?php echo base_url(); ?>/productosContr/nuevo" class="btn btn-info">Agregar</a>
                    <a href="<?php echo base_url(); ?>/productosContr/eliminados" class="btn btn-warning">Eliminados</a>
                </p>
