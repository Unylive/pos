    ...
    <main>
        <div class="container-fluid">
            ...
            <!-- a los botones agregamos el diseño con "class" -->
                <p>
                    <a href="<?php echo base_url(); ?>/clientesContr/nuevo" class="btn btn-info">Agregar</a>
                    <a href="<?php echo base_url(); ?>/clientesContr/eliminados" class="btn btn-warning">Eliminados</a>
                </p>
                    ...
                    <tbody>
                        ...
                        <?php foreach ($datos as $dato) { ?>
                            <tr>
                                ...
                                <td><a href="<?php echo base_url(). '/clientesContr/editar/' .  $dato['id_clt']; ?>" 
                                class="btn btn-warning"><i class="fas fa-pencil-alt"></i></a></td>
                                
                                
                                <td><a href="#" data-href="<?php echo base_url(). '/clientesContr/eliminar/' . $dato['id_clt']; ?>" 
