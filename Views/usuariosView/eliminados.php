  ...
  <main>
    <div class="container-fluid">
      ...
      <div>
        ...
        <p>
          <a href="<?php echo base_url(); ?>/usuariosContr" class="btn btn-warning">Volver a Usuarios</a>
        </p>
          ...
          <tbody>
            ...
            <?php foreach ($datos as $dato) { ?>
              <tr>
                ...
                <td><a href="#" data-href="<?php echo base_url() . '/usuariosContr/reingresar/' . 
                $dato['id_user']; ?>" data-toggle="modal" data-target="#modal-confirma" data.placement="top" 
                title="Reingresar Registro" class="btn btn-success"><i class="fas fa-arrow-alt-circle-left"></i></a></td>
