    ...
    <main>
        <div class="container-fluid">
            ...
            <!-- a los botones agregamos el diseño con "class" -->
                <p>
                    <a href="<?php echo base_url(); ?>/proveedoresContr/nuevo" class="btn btn-info">Agregar</a>
                    <a href="<?php echo base_url(); ?>/proveedoresContr/eliminados" class="btn btn-warning">Eliminados</a>
                </p>
                    ...
                    <tbody>
                        ...
                        <?php foreach ($datos as $dato) { ?>
                            <tr>
                                ...
                                <td><?php echo $dato['cod_prov']; ?></td>
                                <td><?php echo $dato['nomb_prov']; ?></td>
                                <td><?php echo $dato['direc_prov']; ?></td>
                                <td><?php echo $dato['fono1_prov']; ?></td>
                                <td><?php echo $dato['celu1_prov']; ?></td>
                                <td><?php echo $dato['email_prov']; ?></td>
                                

                                <td><a href="<?php echo base_url(). '/proveedoresContr/editar/' .  $dato['id_prov']; ?>" 
                                class="btn btn-warning"><i class="fas fa-pencil-alt"></i></a></td>
                                
                                
                                <td><a href="#" data-href="<?php echo base_url(). '/proveedoresContr/eliminar/' . $dato['id_prov']; ?>" 
