  ...
  <main>
    <div class="container-fluid">
      ...
      <div>
        ...
        <p>
          <a href="<?php echo base_url(); ?>/proveedoresContr" class="btn btn-warning">Volver a Clientes</a>
        </p>
          ...
          <tbody>
            ...
            <?php foreach ($datos as $dato) { ?>
              <tr>
                ...
                <td><a href="#" data-href="<?php echo base_url() . '/proveedoresContr/reingresar/' . 
                $dato['id_prov']; ?>" data-toggle="modal" data-target="#modal-confirma" data.placement="top" 
