  ...
  <main>
    <div class="container-fluid">
      ...
      <div>
        ...
        <p>
          <a href="<?php echo base_url(); ?>/productosContr" class="btn btn-warning">Volver a Productos</a>
        </p>
        ...
        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
          ...
          <tbody>
            ...
            <?php foreach ($datos as $dato) { ?>
              <tr>
                td>
                  <?php echo $dato['id_prod']; ?></td>
                  <td><?php echo $dato['cod_prod']; ?></td>
                  <td><?php echo $dato['nomb_prod']; ?></td>
                  <td><?php echo $dato['precio_vnta']; ?></td>
                  <td><?php echo $dato['exiten_prod']; ?></td>

                <td><a href="#" data-href="<?php echo base_url() . '/productosContr/reingresar/' . 
                $dato['id_prod']; ?>" data-toggle="modal" data-target="#modal-confirma" data.placement="top" 
                title="Reingresar Registro" class="btn btn-warning"><i class="fas fa-pencil-alt"></i></a></td>
