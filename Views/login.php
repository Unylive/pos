...
<body class="bg-primary">
    <?php print_r($user_session->nomb_user); ?>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-5">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                ...
                                <div class="card-body">
                                    <!--agregamos un method tipo post con un action en cual va direccionar donde se va a dirigir - en este caso
                                        //vamos a un metodo llamado valida-->
                                    <form method="POST" action="<?php echo base_url(); ?>/usuariosContr/valida">
                                        ...
                                        <div class="form-group">
                                            <label class="small mb-1" for="password_user">Contraseña</label>
                                            <input class="form-control py-4" id="password_user" name="password_user" type="password" placeholder="Ingresa tu contraseña" />
                                        </div>
